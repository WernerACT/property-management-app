...
use App\Filament\Resources\PropertyDescriptionResource\Pages;
use App\Filament\Resources\PropertyDescriptionResource\RelationManagers;
...
class PropertyDescriptionResource extends Resource
{
    protected static ?string $model = PropertyDescription::class;
    ...
    {
        return [
            'index' => Pages\ListPropertyDescriptions::route('/'),
            'create' => Pages\CreatePropertyDescription::route('/create'),
            'edit' => Pages\EditPropertyDescription::route('/{record}/edit'),
        ];
    }
}
